...
function(GENERATE_ARDUINO_LIBRARY INPUT_NAME)
    ...
    foreach(LIB_DEP ${TARGET_LIBS})
        ...
        # Added part (fix to clean dependencies includes)
        if(EXISTS ${LIB_DEP}/src)
            set(LIB_DEP_INCLUDES "${LIB_DEP_INCLUDES} -I\"${LIB_DEP}/src\"")
        endif()
    endforeach()
    ...
    arduino_debug_msg("For library ${INPUT_NAME}, srcs: ${ALL_SRCS}")
...
function(GENERATE_ARDUINO_FIRMWARE INPUT_NAME)
    ...
    # @TODO: Remove below
    arduino_debug_msg("Target libs: ${TARGET_LIBS}")
    arduino_debug_msg("All libs: ${ALL_LIBS}")
    arduino_debug_msg("Includes dep: ${LIB_DEP_INCLUDES}")
    arduino_debug_msg("setup_arduino_target: ${INPUT_NAME} ${INPUT_BOARD} '${ALL_SRCS}' '${ALL_LIBS}' '${LIB_DEP_INCLUDES}' '' '${INPUT_MANUAL}'")
